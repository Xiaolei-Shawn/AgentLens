...
Trust View helps users inspect:

- outbound activity
- control surfaces
- transparency findings
- background and supporting session activity
...
Trust View is designed around the questions a user may ask after running an agent:
